...
//function to get the magnitude of an earthquake and set the color of the marker depending on the magnitude.
...
//functio to get the magnitude of an earthquake. returns the magnitude * 4 to set the radius of the marker.
